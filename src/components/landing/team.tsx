      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          <div className="lg:col-span-3 flex justify-center">
            <div className="group relative flex flex-col text-center p-8 bg-white dark:bg-deep-grey/20 rounded-xl shadow-lg shadow-black/[0.04] hover:shadow-2xl hover:shadow-primary/20 dark:hover:shadow-primary/20 hover:-translate-y-2 transition-all duration-300 animate-fade-in w-full max-w-md" style={{ animationDelay: '0.1s' }}>
              <div className="mb-4">
          ...
          <div className="group relative flex flex-col text-center p-8 bg-white dark:bg-deep-grey/20 rounded-xl shadow-lg shadow-black/[0.04] hover:shadow-2xl hover:shadow-primary/20 dark:hover:shadow-primary/20 hover:-translate-y-2 transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.3s' }}>
           ...
           <div className="group relative flex flex-col text-center p-8 bg-white dark:bg-deep-grey/20 rounded-xl shadow-lg shadow-black/[0.04] hover:shadow-2xl hover:shadow-primary/20 dark:hover:shadow-primary/20 hover:-translate-y-2 transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            ...
            <h3 className="text-xl font-bold font-heading text-deep-grey dark:text-white">Shivam Prasad</h3>
            <p className="text-sm text-primary dark:text-light-green font-bold mt-1">School of Computer Eng., ML Developer</p>
            <p className="mt-4 text-deep-grey/80 dark:text-white/70 font-soft text-base flex-grow">Shivam focuses on implementing and fine-tuning the machine learning models that power our platform's predictions. He plays a key role in the research and development of new AI capabilities to address agricultural challenges.</p>
          </div>
          <div className="md:col-start-2 lg:col-start-auto group relative flex flex-col text-center p-8 bg-white dark:bg-deep-grey/20 rounded-xl shadow-lg shadow-black/[0.04] hover:shadow-2xl hover:shadow-primary/20 dark:hover:shadow-primary/20 hover:-translate-y-2 transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.5s' }}>
            <div className="mb-4">
              <div className="size-24 mx-auto rounded-full bg-primary/10 dark:bg-light-green/10 flex items-center justify-center text-primary dark:text-light-green transition-all duration-300 group-hover:scale-110">
                <span className="material-symbols-outlined text-5xl">integration_instructions</span>
              </div>
            </div>
            <h3 className="text-xl font-bold font-heading text-deep-grey dark:text-white">Shubham Kumar Singh</h3>
            <p className="text-sm text-primary dark:text-light-green font-bold mt-1">School of Computer Eng., Full Stack – Developer</p>
            <p className="mt-4 text-deep-grey/80 dark:text-white/70 font-soft text-base flex-grow">Shubham contributes to both the front-end and back-end development of the platform. His expertise ensures that new features are seamlessly integrated and that the application remains performant and scalable for all users.</p>
          </div>
        </div>
      </div>
    </section>
