    ...
    <section id="impact" className="py-24 bg-background-light dark:bg-black/20">
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white dark:bg-deep-grey/20 p-8 rounded-xl shadow-lg shadow-black/[0.04] transition-all duration-300 hover:shadow-primary/20 hover:-translate-y-2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="bg-white dark:bg-deep-grey/20 p-8 rounded-xl shadow-lg shadow-black/[0.04] transition-all duration-300 hover:shadow-primary/20 hover:-translate-y-2 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="bg-white dark:bg-deep-grey/20 p-8 rounded-xl shadow-lg shadow-black/[0.04] transition-all duration-300 hover:shadow-primary/20 hover:-translate-y-2 animate-fade-in" style={{ animationDelay: '0.6s' }}>
