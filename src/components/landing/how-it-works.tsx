    ...
    <section className="py-24 bg-pattern">
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="relative flex flex-col md:flex-row justify-between items-center gap-12 md:gap-0">
          ...
          <div className="relative flex flex-col items-center text-center max-w-xs animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="relative flex flex-col items-center text-center max-w-xs animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <div className="z-10 flex items-center justify-center size-20 rounded-full bg-primary text-white shadow-lg shadow-primary/30">
          ...
          <div className="relative flex flex-col items-center text-center max-w-xs animate-fade-in" style={{ animationDelay: '0.6s' }}>
            <div className="z-10 flex items-center justify-center size-20 rounded-full bg-primary text-white shadow-lg shadow-primary/30">
